from gemma_fine_tuning_main import pick_balanced_data,read_data, balanced_split, create_model_and_tokenizer
import json
import re
...
def generate_test_prompt(
    conversation: str, system_prompt: str
) -> str:
...
if __name__ == "__main__":
    ...
    predicted = (test_df['predicted_output'].str.replace(r"[^TrueFalse]", "", regex=True).str.lower() == 'true').astype(int)
